...
def crearReserva():
    ...
    try:
        ...
        return
            ...
            Accion("Error", "Formato incorrecto en cédula o fecha").guardar()
            print('\n( X ) Formato incorrecto en cédula o fecha')
...
def nomina():
    ...
    if hotel == "1":
        ...
        hotel = lista_hoteles.obtener(3)
    while True:
        print()
        print('___')
        print('\nMENÚ DE GESTIÓN DE NÓMINAS |'+ hotel)
        print('___')
        ...
        match opcion:
            case 0:
                ...
                objeto = empleado(hotel,nom,pos,sal,fec)
                ...
                while band == True: 
                    ...
                    while bandi == True: 
                        ...
                        match op:
                            ...
                            case 99:
                                bandi = False
                    var = int(input('Deseas seleccionar otro Hotel(Si = 1 / No = 0): '))
                    if var == 0: 
                        band = False        
            case 4: 
                print('\n___')
